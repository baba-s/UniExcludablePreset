...
namespace Kogane.Internal
{
	...
	/// </summary>
	internal sealed class ExcludablePresetSettings : ScriptableObjectForPreferences<ExcludablePresetSettings>
	{
		//================================================================================
		// 定数
		//================================================================================
		private static readonly string PACKAGE_NAME        = "UniExcludablePreset";
